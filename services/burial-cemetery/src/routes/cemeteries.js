  ...
  try {
    ...
    const newCemetery = await prisma.cemetery.create({
      data: {
        ...
        totalArea: totalArea ? totalArea.toString() : null,
        boundary: boundary || null,
        standardPrice: standardPrice ? parseFloat(standardPrice.toString()) : 5000.00,
        largePrice: largePrice ? parseFloat(largePrice.toString()) : 8000.00,
        familyPrice: familyPrice ? parseFloat(familyPrice.toString()) : 15000.00,
        nichePrice: nichePrice ? parseFloat(nichePrice.toString()) : 3000.00,
        maintenanceFee: maintenanceFee ? parseFloat(maintenanceFee.toString()) : 500.00,
        isActive: true
      }
    });
