...
export default function UnderReviewRegistrationsPage() {
  ...
  const fetchRegistrations = useCallback(async (page = 1, limit = 10) => {
    ...
    try {
      ...
      const url = `/api/death-registrations?page=${page}&limit=${limit}&status=PENDING_VERIFICATION`
      ...
      console.error('Error fetching under review registrations:', err)
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between">
            <div>
              ...
              <h1 className="text-3xl font-bold text-gray-900 mt-2">Under Review Registrations</h1>
              <p className="text-gray-600 mt-2">Applications currently being reviewed</p>
            </div>
            <div className="flex items-center space-x-4">
              <div className="text-sm text-gray-600">
                <span className="font-medium">{totalCount}</span> under review
              </div>
            </div>
          </div>
        </div>
        ...
        {loading && (
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-12">
            <div className="flex flex-col items-center justify-center">
              ...
              <p className="text-gray-600">Loading under review registrations...</p>
            </div>
          </div>
        )}
          ...
          <div className="mb-8 bg-red-50 border border-red-100 rounded-2xl p-6 shadow-sm">
            <div className="flex items-start">
              ...
              <div className="ml-4 flex-1">
                <h3 className="text-lg font-semibold text-red-800">Unable to load under review registrations</h3>
                    ...
                    <tr>
                      <td colSpan={7} className="px-6 py-12 text-center">
                        <div className="flex flex-col items-center justify-center">
                          ...
                          <h3 className="text-lg font-medium text-gray-900 mb-2">No registrations under review</h3>
                          <p className="text-gray-500 text-sm">All applications have been processed or no applications are currently under review.</p>
                        </div>
                      </td>
                    </tr>
                  )}
