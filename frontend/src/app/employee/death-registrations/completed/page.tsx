...
export default function CompletedRegistrationsPage() {
  ...
  const fetchRegistrations = useCallback(async (page = 1, limit = 10) => {
    ...
    try {
      ...
      const url = `/api/death-registrations?page=${page}&limit=${limit}&status=REGISTERED`
      ...
      console.error('Error fetching completed registrations:', err)
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between">
            <div>
              ...
              <h1 className="text-3xl font-bold text-gray-900 mt-2">Completed Registrations</h1>
              <p className="text-gray-600 mt-2">Fully processed death registration applications</p>
            </div>
        ...
        {loading && (
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-12">
            <div className="flex flex-col items-center justify-center">
              ...
              <p className="text-gray-600">Loading completed registrations...</p>
            </div>
          </div>
        )}
          ...
          <div className="mb-8 bg-red-50 border border-red-100 rounded-2xl p-6 shadow-sm">
            <div className="flex items-start">
              ...
              <div className="ml-4 flex-1">
                <h3 className="text-lg font-semibold text-red-800">Unable to load completed registrations</h3>
                    ...
                    <tr>
                      <td colSpan={7} className="px-6 py-12 text-center">
                        <div className="flex flex-col items-center justify-center">
                          ...
                          <h3 className="text-lg font-medium text-gray-900 mb-2">No completed registrations</h3>
                          <p className="text-gray-500 text-sm">No applications have been completed yet.</p>
                        </div>
                      </td>
                    </tr>
                  )}
